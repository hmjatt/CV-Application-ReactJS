# CV-Application-ReactJS 📜

Creating a **`CV Application`** app using `ReactJS`

<!-- ## [Live Preview](https://hmjatt.github.io/CV-Application-ReactJS/)
...
Create a **`CV Application`** app using `ReactJS`. By creating this project I learned about `Event Listeners in React`, `React State`, `Conditional Rendering in React`, `React Forms`, `React Hooks(useEffect)`, `Lazy State Initialization`, etc. After creating the project, it was deployed to `GitHub Pages` :bird: Feel free to reach me on[Twitter](https://twitter.com/hmjatt/) 🪶
